...
Place the GearSwitcher.dll file into your Hollow Knightís Mods folder.
Run the game.
...
*Key 0, Key 1, Key 2, Ö, Key 9 (the number keys on the main keyboard)
* A, B, C, Ö, Z (letter keys)
* F1, F2, Ö, F12 (function keys)
* Pad0, Pad1, Ö Pad9 (keypad number keys)
...
**Key Conflicts**: Be aware that key bindings may conflict with other mods or with the gameís default controls. If you experience conflicts, youíll need to choose different key bindings.\
